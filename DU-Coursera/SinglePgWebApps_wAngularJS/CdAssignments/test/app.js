(function() {
  ...
  .constant('ApiBasePath', "https://nvt124589.github.io/DU-Coursera/SinglePgWebApps_wAngularJS/CdAssignments");
  ...
  function FoundItemsDirective() {
    var ddo = {
      templateUrl: '/DU-Coursera/SinglePgWebApps_wAngularJS/CdAssignments/foundItems.html',      
      scope: {
        items: '<',
        title: '@title',
        message: '@message',
